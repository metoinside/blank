...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7524)), "/workspace/blank/app/page.js"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2756)), "/workspace/blank/app/layout.js"],
          
        }
      ]
      }.children;
    const pages = ["/workspace/blank/app/page.js"];
...
function Page() {
    const [counter, setCount] = react__WEBPACK_IMPORTED_MODULE_2___default().useState(0);
    function increase() {
        setCount(counter + 1);
    }
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/workspace/blank/app/page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [84,985], () => (__webpack_exec__(9557)));
